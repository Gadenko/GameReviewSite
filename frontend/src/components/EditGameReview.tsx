    ...
    return(
        <div>
            ...
            <form onSubmit={saveNewGameReview}>
                ...
                <input type="text" defaultValue={headline} onChange={e => {setHeadline(e.target.value)}}/>
                <input type="text" defaultValue={gameDescription} onChange={e => {setGameDescription(e.target.value)}}/>
                <input type="url" defaultValue={picture} onChange={e => {setPicture(e.target.value)}}/>
